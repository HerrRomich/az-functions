...
describe('AzureLogTransport', () => {
  ...
  describe('testLogger without invocation context', () => {
    ...
    describe('with log level service', () => {
      beforeEach(() => {
      ...
      it('should not log if below available log level', () => {
        ...
        expect(mockPlatformLogger.info).not.toHaveBeenCalled();
        expect(mockNext).toHaveBeenCalled();
      });
    ...
    describe('without log level service', () => {
      beforeEach(() => {
        subject = new AzureLogTransport(mockContextStorage, mockPlatformLogger, undefined);
      });

      it('should log if at or above available default log level', () => {
        subject.log(
          {
            [LEVEL]: 'error',
            category: 'category',
      ...
      it('should not log if below available default log level', () => {
        subject.log(
          {
            [LEVEL]: 'debug',
            category: 'category',

import { GeoJSONPointSchema, IdDtoSchema } from '@fleet-sight/shared/rest';
import { z } from 'zod';
...
export const TruckDtoSchema = z
  .object({
    ...
    location: GeoJSONPointSchema.openapi({
    ...
    destinationPoint: GeoJSONPointSchema.optional().openapi({
    ...
    runId: z.uuidv7().optional(),
  })
  .openapi('truck');

export type TruckDto = z.infer<typeof TruckDtoSchema>;

export const TrucksDtoSchema = TruckDtoSchema.array().openapi('trucks');
export type TrucksDto = z.infer<typeof TrucksDtoSchema>;
